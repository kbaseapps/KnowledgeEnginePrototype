SERVICE = knowledgeengineprototype
SERVICE_CAPS = KnowledgeEnginePrototype
SPEC_FILE = KnowledgeEnginePrototype.spec
URL = https://kbase.us/services/knowledgeengineprototype
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
